...
public class SignStepFinishFragment extends Fragment implements BlockingStep {
    ...
    public static SignStepFinishFragment newInstance() {
        SignStepFinishFragment fragment = new SignStepFinishFragment();
        return fragment;
    }
    ...
    class TokenRequest extends Request<byte[]> {
        ...
        public TokenRequest(String url, Response.Listener<String> listener, Response.ErrorListener elistener) {
            ...
            super(Method.GET, url, elistener);
            mListener = listener;
        }
